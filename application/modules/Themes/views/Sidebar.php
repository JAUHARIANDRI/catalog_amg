                ...
                <div class="category-content">
                    <div class="media">
                        ...
                        <div class="media-body">
                            <span class="media-heading text-semibold"><?= $this->session->userdata('nama_customer') ?></span>
                ...
                <div class="category-content no-padding">
                    <ul class="navigation navigation-main navigation-accordion">
                        ...
                        <li class="<?= $aktifMasterList ?>">
                            <a href="#"><i class="icon-stack2"></i> <span>Master List</span></a>
                            <ul <?= $MasterList ?>>
                        ...
                        <li class="<?= $aktifMasterList ?>">
                            <a href="#"><i class="icon-stack2"></i> <span>Master Plating</span></a>
                            <ul <?= $MasterList ?>>
                        ...
                        <li>
                            <a href="#"><i class="icon-stack2"></i><span>Metal List</span></a>
                            <ul>
                        ...
                        <li>
                            ...
                            <ul>
                                ...
                                <li class="disabled"><a href="../../../layout_6/LTR/index.html" id="layout6">Layout 6 <span class="label label-transparent">Coming
                                            soon</span></a></li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li><a href="../../RTL/default/index.html"><i class="icon-width"></i> <span>RTL
                                    version</span></a></li>
                        <!-- /main -->
