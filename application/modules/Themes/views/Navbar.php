            ...
            <ul class="nav navbar-nav navbar-right">
                <!-- <li class="dropdown language-switch">
                    ...
                    <ul class="dropdown-menu">
                        <li><a class="deutsch"><img src="<?= base_url() ?>assets/images/flags/de.png" alt=""> Deutsch</a></li>
                        <li><a class="ukrainian"><img src="<?= base_url() ?>assets/images/flags/ua.png" alt=""> Українська</a></li>
                        <li><a class="english"><img src="<?= base_url() ?>assets/images/flags/gb.png" alt=""> English</a></li>
                        <li><a class="espana"><img src="<?= base_url() ?>assets/images/flags/es.png" alt=""> España</a></li>
                        <li><a class="russian"><img src="<?= base_url() ?>assets/images/flags/ru.png" alt=""> Русский</a></li>
                    </ul>
                </li> -->
