            ...
            <div class="content-wrapper">
                ...
                <div class="content">
                                ...
                                <div class="panel registration-form">
                                    <div class="panel-body">
                                        ...
                                        <div class="text-right">
                                            ...
                                            <a href="<?= base_url('Logadm') ?>">Back To Login</a>

                                            <!-- <a href="<?= base_url('LogAdm') ?>"></a><button type="submit" class="btn btn-link"><i class="icon-arrow-left13 position-left"></i> Back to login form</button> -->
                    ...
                    <div class="footer text-muted text-center">
                        &copy; 2020. <a href="#">Sistem Integrator</a> by <a href="#" target="_blank">NSI</a>
                    </div>
                    <!-- /footer -->
